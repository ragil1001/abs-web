...
const DataProject = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.lokasi.nama.trim())
      errors.lokasi_nama = "Nama lokasi wajib diisi";
    if (!formData.lokasi.latitude)
      errors.lokasi_latitude = "Latitude wajib diisi";
    if (!formData.lokasi.longitude)
      errors.lokasi_longitude = "Longitude wajib diisi";
    ...
    formData.shifts.forEach((shift, index) => {
      if (!shift.kode || !shift.kode.trim())
        errors[`shift_${index}_kode`] = "Kode shift wajib diisi";
      if (!shift.waktu_mulai)
        errors[`shift_${index}_mulai`] = "Waktu mulai wajib diisi";
      if (!shift.waktu_selesai)
        errors[`shift_${index}_selesai`] = "Waktu selesai wajib diisi";
    });
  ...
  const performSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        waktu_toleransi: formData.waktu_toleransi
          ? parseInt(formData.waktu_toleransi)
          : null,
  ...
  const exportToExcel = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/projects/export`,
        {
          method: "GET",
          headers: {
      ...
      <div className="h-64 rounded-lg overflow-hidden border border-gray-200">
        ...
        >
          ...
          <Marker position={[lat, lng]} icon={customIcon}>
            <Popup>
              <strong>{formData.lokasi.nama || "Lokasi Project"}</strong>
              <br />
              Koordinat: {lat}, {lng}
            </Popup>
          </Marker>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full border px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${
                formErrors.tanggal_mulai ? "border-red-500" : "border-gray-200"
              }`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${
                formErrors.bagian ? "border-red-500" : "border-gray-200"
              }`}
              placeholder="Masukkan jabatan"
            />
            {formErrors.bagian && (
              <p className="text-red-500 text-sm mt-1">{formErrors.bagian}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full border px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${
                formErrors.lokasi_nama ? "border-red-500" : "border-gray-200"
              }`}
              placeholder="Masukkan nama lokasi"
            />
            {formErrors.lokasi_nama && (
              <p className="text-red-500 text-sm mt-1">
                {formErrors.lokasi_nama}
              </p>
            )}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleFormChange("waktu_toleransi", e.target.value)
              }
            ...
            <p className="text-xs text-gray-500 mt-1">
              Berapa menit sebelum shift dimulai karyawan bisa absen (opsional)
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <p className="text-sm text-gray-600">
            Buka Google Maps untuk mendapatkan koordinat
          </p>
          <button
            type="button"
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${
              formErrors.radius ? "border-red-500" : "border-gray-200"
            }`}
          ...
          />
          {formErrors.radius && (
            <p className="text-red-500 text-sm mt-1">{formErrors.radius}</p>
          )}
          <p className="text-xs text-gray-500 mt-1">
        ...
        <div className="border-t pt-4">
          ...
          <p className="text-xs text-gray-600 mb-3">
            Pilih jabatan yang tidak perlu berada dalam radius untuk presensi
            (contoh: Driver, Kurir, dll)
          </p>
          ...
          {formData.excluded_jabatan_ids &&
            formData.excluded_jabatan_ids.length > 0 && (
              <div className="mt-2 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                <p className="text-xs text-orange-800">
                  <strong>{formData.excluded_jabatan_ids.length}</strong>{" "}
                  jabatan dikecualikan dari pengecekan radius. Karyawan dengan
                  jabatan tersebut dapat presensi dari lokasi manapun.
                </p>
              </div>
            )}
        </div>
        ...
        <div className="border-t pt-4">
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-blue-800">
                <p className="font-medium mb-1">
                  Kategori Izin yang Otomatis Aktif:
                </p>
                <ul className="list-disc list-inside space-y-1 text-xs">
                  <li>
                    <strong>Sakit</strong> - Tersedia di semua project (wajib
                    lampir surat dokter)
                  </li>
                  <li>
                    <strong>Izin Umum</strong> - Tersedia di semua project
                    (urusan pribadi)
                  </li>
                </ul>
              </div>
          ...
          <p className="text-xs text-gray-600 mb-4">
            Pilih kategori izin tambahan yang ingin diaktifkan untuk project
            ini:
          </p>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-indigo-100 border border-indigo-200 rounded-lg p-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <input
                    type="checkbox"
                    checked={(formData.enabled_izin_categories || []).includes(
                      "cuti_tahunan"
                    )}
                    onChange={(e) => {
                      let categories = [
                        ...(formData.enabled_izin_categories || [
                          "sakit",
                          "izin",
                        ]),
                      ];
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">
                      Cuti khusus untuk acara penting (pernikahan, kematian,
                      dll). Semua sub kategori akan otomatis aktif.
                    </p>
                  </div>
                </label>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="text-sm text-purple-800">
                  <p className="font-medium mb-2">
                    Sub Kategori Cuti Khusus (Semua Aktif):
                  </p>
          ...
          <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-4">
            <div className="flex gap-3">
              ...
              <div className="text-sm text-amber-800">
                ...
                <ul className="list-disc list-inside space-y-1 text-xs">
                  <li>
                    <strong>Sakit</strong> dan <strong>Izin Umum</strong>{" "}
                    otomatis aktif di semua project
                  </li>
                  <li>
                    <strong>Cuti Tahunan</strong> bersifat opsional dan dapat
                    dipilih sesuai kebutuhan
                  </li>
                  <li>
                    <strong>Cuti Khusus</strong> jika diaktifkan, semua sub
                    kategorinya akan otomatis tersedia
                  </li>
                  <li>
                    Konfigurasi ini menentukan kategori izin yang dapat diajukan
                    karyawan di project ini
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div>
          ...
          {formData.shifts.map((s, i) => (
            <div
              key={`shift-${i}`}
              className="space-y-2 mb-4 p-4 bg-gray-50 rounded-lg"
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    value={s.waktu_mulai}
                    onChange={(e) =>
                      handleShiftChange(i, "waktu_mulai", e.target.value)
                    }
                    className={`w-full border px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleShiftChange(i, "waktu_selesai", e.target.value)
                    }
                    className={`w-full border px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-gray-600">
              Kelola data project perusahaan dengan lokasi koordinat
            </p>
          </div>
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div>
                        ...
                        {p.excluded_jabatan_ids &&
                          p.excluded_jabatan_ids.length > 0 && (
                            <div className="flex items-center gap-1 mt-1">
                              <Shield className="w-3 h-3 text-orange-600" />
                              <span className="text-xs text-orange-600">
                                {p.excluded_jabatan_ids.length} jabatan
                                dikecualikan
                              </span>
                            </div>
                          )}
                        {p.enabled_izin_categories &&
                          p.enabled_izin_categories.length > 0 && (
                            <div className="flex items-center gap-1 mt-1">
                              <FileText className="w-3 h-3 text-blue-600" />
                              <span className="text-xs text-blue-600">
                                {p.enabled_izin_categories.length} kategori izin
                                aktif
                              </span>
                            </div>
                          )}
