...
const PresensiHarian = () => {
  ...
  const handleStatusChange = useCallback(
    async (item, newStatus) => {
      const presensiField =
        activeTab === "masuk" ? "presensi_masuk" : "presensi_pulang";
      ...
      const result = await Swal.fire({
        ...
        html: `Ubah status presensi <b>${
          activeTab === "masuk" ? "masuk" : "pulang"
        }</b> karyawan <b>${item.nama}</b> menjadi <b>${
      ...
      try {
        const response = await call(
          presensiHarianAPI.updateStatus,
          presensi.id,
          {
            status: newStatus,
          }
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-gray-600">
              Rekap absensi karyawan berdasarkan project dan tanggal
            </p>
          </div>
          <div className="flex gap-2">
            <button
            ...
            <button
              ...
              disabled={
                !selectedProject || !selectedDate || attendanceData.length === 0
              }
      ...
      {projectInfo && (
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          <h3 className="text-xl font-semibold mb-6 flex items-center gap-2">
            ...
            Detail Project & Statistik Presensi{" "}
            {activeTab === "masuk" ? "Masuk" : "Pulang"}
          </h3>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <div className="flex items-center gap-2">
                    <p className="font-semibold text-gray-900 flex-1">
                      {projectInfo.lokasi?.nama || "-"}
                    </p>
                    {projectInfo.lokasi?.latitude &&
                      projectInfo.lokasi?.longitude && (
                        <button
                          onClick={() =>
                            openGoogleMaps(
                              projectInfo.lokasi.latitude,
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className="font-semibold text-gray-900">
                    {projectInfo.total_karyawan} orang
                  </p>
                </div>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-emerald-100 to-emerald-200 border border-emerald-300 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-emerald-700">
                    {activeTab === "masuk"
                      ? statistics.masuk.hadir
                      : statistics.pulang.hadir}
                  </div>
                ...
                {activeTab === "masuk" ? (
                  ...
                  <div className="bg-gradient-to-br from-rose-100 to-rose-200 border border-rose-300 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-rose-700">
                      {statistics.pulang.tidak_presensi_pulang}
                    </div>
                ...
                <div className="bg-gradient-to-br from-blue-100 to-blue-200 border border-blue-300 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-blue-700">
                    {activeTab === "masuk"
                      ? statistics.masuk.izin
                      : statistics.pulang.izin}
                  </div>
                ...
                <div className="bg-gradient-to-br from-red-100 to-red-200 border border-red-300 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-red-700">
                    {activeTab === "masuk"
                      ? statistics.masuk.alpa
                      : statistics.pulang.alpa}
                  </div>
                ...
                <div className="bg-gradient-to-br from-violet-100 to-violet-200 border border-violet-300 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-violet-700">
                    {activeTab === "masuk"
                      ? statistics.masuk.libur
                      : statistics.pulang.libur}
                  </div>
                  ...
                  <>
                    ...
                    <div className="bg-gradient-to-br from-yellow-100 to-yellow-200 border border-yellow-300 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-yellow-700">
                        {statistics.pulang.pulang_cepat}
                      </div>
      ...
      {selectedProject && selectedDate ? (
              ...
              <tbody>
                {paginatedData.length > 0 ? (
                  paginatedData.map((item, idx) => {
                    ...
                    const statusInfo =
                      statusConfig[currentStatus] || statusConfig.alpa;
                        ...
                        <td className="px-4 py-3">
                          {presensi?.foto ? (
                            <img
                              ...
                              onClick={() =>
                                window.open(presensi.foto, "_blank")
                              }
        ...
        <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">
            Pilih Project dan Tanggal
          </h3>
          <p className="text-gray-600">
            Silakan pilih project dan tanggal untuk melihat data presensi harian
          </p>
        </div>
      )}
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
              <h2 className="text-xl font-semibold">
                Detail Presensi {activeTab === "masuk" ? "Masuk" : "Pulang"}
              </h2>
              <button
            ...
            <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <span className="text-sm text-gray-500">
                        Waktu {activeTab === "masuk" ? "Masuk" : "Pulang"}:
                      </span>
                      <p className="font-medium">
                        {activeTab === "masuk"
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        {(() => {
                          const currentStatus =
                            getDisplayStatus(selectedAttendance);
                          const statusInfo =
                            statusConfig[currentStatus] || statusConfig.alpa;
              ...
              {(() => {
                const presensi =
                  activeTab === "masuk"
                    ? selectedAttendance.presensi_masuk
                    : selectedAttendance.presensi_pulang;
