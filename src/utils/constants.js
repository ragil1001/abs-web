...
export const KATEGORI_IZIN_TYPES = {
  ...
  CUTI_TAHUNAN: { value: 'cuti_tahunan', label: 'Cuti Tahunan', kode: 'CT', color: 'indigo' },
  CUTI_KHUSUS: { value: 'cuti_khusus', label: 'Cuti Izin Khusus', kode: 'IK', color: 'cyan' }
};

// Sub Kategori Cuti Khusus
export const SUB_KATEGORI_CUTI_KHUSUS = {
  PERNIKAHAN_KARYAWAN: { value: 'pernikahan_karyawan', label: 'Pernikahan Karyawan', durasi: 3 },
  PERNIKAHAN_ANAK: { value: 'pernikahan_anak', label: 'Pernikahan Putra/Putri', durasi: 2 },
  ISTRI_MELAHIRKAN: { value: 'istri_melahirkan', label: 'Istri Melahirkan/Keguguran', durasi: 2 },
  KEMATIAN_KELUARGA: { value: 'kematian_keluarga', label: 'Kematian Keluarga Inti', durasi: 2 },
  KEMATIAN_SERUMAH: { value: 'kematian_serumah', label: 'Kematian Orang Serumah', durasi: 1 },
  KHITANAN_BAPTIS: { value: 'khitanan_baptis', label: 'Khitanan/Baptisan Anak', durasi: 2 }
};